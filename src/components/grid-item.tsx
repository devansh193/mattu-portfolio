...
export const GridItem = ({ area, icon, title, description }: GridItemProps) => {
  return (
    <li className={`min-h-[14rem] list-none ${area}`}>
      <div className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3 bg-neutral-950 border-neutral-800">
        <GlowingEffect
          spread={40}
          glow={true}
          disabled={false}
          ...
          inactiveZone={0.01}
        />
        <div className="border-0.75 relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-8 md:p-6 dark:shadow-[0px_0px_27px_0px_#2D2D2D]">
