...
export const About = () => {
  return (
    <div className="relative flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 w-full">
      <h1 className="text-xl sm:text-2xl font-bold text-[#737373] py-4 z-10">
        ABOUT
      </h1>

      <div className="relative w-full max-w-5xl mx-auto rounded-3xl overflow-hidden bg-[#0A0A0A] px-4 sm:px-8 py-8 sm:py-12 lg:py-16 flex flex-col lg:flex-row items-start lg:items-center justify-start gap-4 min-h-[300px] z-10">
        ...
        {/* Text content */}
        <div className="z-10 w-full lg:w-3/4 flex flex-col gap-4">
          ...
          <p className="text-[#878585] text-left font-sans text-sm sm:text-base md:text-lg font-medium leading-relaxed">
            ...
            engaging, results-driven videos. Whether it&apos;s storytelling,
            editing, or polishing visuals — I&apos;m here to make your content
            stand out.
          </p>
